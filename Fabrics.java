...
public class Fabrics extends Organization {
  ...
  public Fabrics(
      String name, int foundationYear, String productionType, int productionCapacity) {
  ...
  public boolean equals(Object o) {
	...
	result = cmpDefaultAttributes(fabrics.name, fabrics.foundationYear) && cmpSpecificAttributes(fabrics.productionType, fabrics.productionCapacity);
    }
    return result;
  }
 ...
 public int hashCode() {
  ...
  private String fabricsAttributes() {
	  return ", Production type = " + productionType + ", Production capacity = " + productionCapacity;
  }
}
